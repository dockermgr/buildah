...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202302262024-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2023 Jason Hempstead, Casjays Developments
# @@Created          :  Sunday, Feb 26, 2023 20:24 EST
# @@File             :  install.sh
...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/buildah"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="buildah"
APPDIR="$HOME/.local/share/srv/docker/buildah"
INSTDIR="$HOME/.local/share/CasjaysDev/dockermgr/buildah"
DATADIR="$HOME/.local/share/srv/docker/buildah/rootfs"
...
BUILDAH_USERNAME="${BUILDAH_USERNAME:-$DEFAULT_USERNAME}"
BUILDAH_PASSWORD="${BUILDAH_PASSWORD:-$DEFAULT_PASSWORD}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set container hostname and domain - Default buildah
...
SET_USER_NAME="${CONTAINER_USER_NAME:-$BUILDAH_USERNAME}"
SET_USER_PASS="${CONTAINER_USER_PASS:-$BUILDAH_PASSWORD}"
